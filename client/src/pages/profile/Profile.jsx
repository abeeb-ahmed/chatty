        ...
        <div className="profile_right">
          <div className="profile_rightTop">
            <div className="profile_coverImage">
              <img
                src="https://images.unsplash.com/photo-1513002749550-c59d786b8e6c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8c2t5fGVufDB8fDB8fA%3D%3D&auto=format"
                alt=""
              />
            </div>
            ...
            <div className="profile_desc">
              <h4 className="profile_title">Abeeb Ahmed</h4>
              <p className="profile_subTitle">Hello friends</p>
            </div>
          </div>
